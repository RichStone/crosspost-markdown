...
module.exports = {
  ...
  getWebflowArticlesUrl: () => {
    return configstore.get('webflowArticlesUrl')
  },

  getConfigstoreConfig: (key) => {
  ...
  validateSetup: () => {
    ...
    // TODO: must just go through all keys and validate automatically
    ...
    if (module.exports.getConfigstoreConfig('webflowArticlesUrl')) {
      console.log('✅ webflow Articles URL is configured👍')
    } else {
      errors.webflowArticlesUrl = false
      console.log('❌ webflow Articles URL is missing')
    }
